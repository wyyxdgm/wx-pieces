    ...
    auth_open_setting(scope_attr) {
      ...
      return new Promise((Y, N) => {
        wx.openSetting({
          ...
          complete(res) {
            if (res.miniprogramAuthSetting[scope_attr]) {
              Y();
            } else {
              N();
            }
